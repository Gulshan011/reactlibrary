...
//     //register
//     try {
//         const{bookname,authors,publisher,publishedDate} = req.body;
...
//        }
//     }
//     const user = await new bookModel({bookname,authors,publisher,publishedDate}).save()
//     res.status(201).send({
//      success:true,
//      message:'Issed successfully',
//      user,
//     });
//  } catch (error) {
//      console.log(error)
...
export const bookController = async (req, res) => {
  //register
  try {
    const { bookname, publisher, publishedDate } = req.body;
